    ...
    "use strict";
        ...
        document.getElementById('submit').addEventListener('click', function() {
            ...
            if (username === 'Admin' && password === 'Admin') {
                alert.textContent = '¡Bienvenido! Debes registrarte para compartir tus recetas con la comunidad, ver propuestas de cocinas, realizar comentarios y realizar valoraciones.';
                alert.style.color = 'green';
            } else {
                alert.textContent = 'Usuario o contraseña incorrectos. Intenta de nuevo.';
